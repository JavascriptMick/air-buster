...
class NodePackageManager {
    ...
    install(packageName, pathToSave, config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let spawnResult = yield this.getNpmInstallResult(params, cwd);
                if (isInstallingAllDependencies) {
                    return null;
                }
                params = params.concat(["--json", "--dry-run", "--prefix", cwd]);
                let spawnNpmDryRunResult = yield this.$childProcess.spawnFromEvent(this.getNpmExecutableName(), params, "close");
