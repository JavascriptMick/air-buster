...
class AndroidDebugBridge {
    ...
    executeCommand(args, options) {
        return __awaiter(this, void 0, void 0, function* () {
            let event = "close";
            let command = yield this.composeCommand(args);
            ...
            let result = yield this.$childProcess.spawnFromEvent(command.command, command.args, event, childProcessOptions, { throwError: false });
    ...
    composeCommand(params, identifier) {
        return __awaiter(this, void 0, void 0, function* () {
            let command = yield this.$staticConfig.getAdbFilePath();
