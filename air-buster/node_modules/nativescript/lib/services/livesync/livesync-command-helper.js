...
class LiveSyncCommandHelper {
    constructor($platformService, $projectData, $options, $devicesService, $iosDeviceOperations, $mobileHelper, $platformsData, $errors) {
    ...
    executeLiveSyncOperation(devices, liveSyncService, platform) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.$devicesService.detectCurrentlyAttachedDevices({ shouldReturnImmediateResult: false, platform });
            ...
            yield liveSyncService.liveSync(deviceDescriptors, liveSyncInfo);
        });
    }
    runInReleaseMode(platform) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const currentPlatform of availablePlatforms) {
                yield this.$platformService.deployPlatform(currentPlatform, this.$options, deployOptions, this.$projectData, this.$options);
