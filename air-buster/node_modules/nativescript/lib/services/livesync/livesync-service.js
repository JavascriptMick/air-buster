...
class LiveSyncService extends events_1.EventEmitter {
    constructor($platformService, $projectDataService, $devicesService, $mobileHelper, $devicePlatformsConstants, $nodeModulesDependenciesBuilder, $logger, $processService, $hooksService, $pluginsService, $injector) {
        super();
    ...
    liveSyncOperation(deviceDescriptors, liveSyncData, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!liveSyncData.skipWatcher && this.liveSyncProcessesInfo[projectData.projectDir].deviceDescriptors.length) {
                this.$injector.resolve("usbLiveSyncService").isInitialized = true;
    ...
    ensureLatestAppPackageIsInstalledOnDevice(options, nativePrepare) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.preparedPlatforms.indexOf(platform) === -1) {
                ...
                yield this.$platformService.preparePlatform(platform, {
                    bundle: false,
                    release: false,
                }, null, options.projectData, {}, options.modifiedFiles, nativePrepare);
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const deviceAction = (device) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    yield this.refreshApplication(projectData, liveSyncResultInfo);
    ...
    startWatcher(projectData, liveSyncData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!currentWatcherInfo || currentWatcherInfo.pattern !== pattern) {
                ...
                this.$devicesService.on("deviceLost", (device) => __awaiter(this, void 0, void 0, function* () {
                    yield this.stopLiveSync(projectData.projectDir, [device.deviceInfo.identifier]);
                }));
            }
        });
    }
