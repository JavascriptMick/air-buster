...
class IOSDebugService extends debug_service_base_1.DebugServiceBase {
    constructor($devicesService, $platformService, $iOSEmulatorServices, $childProcess, $logger, $errors, $npmInstallationManager, $iOSNotification, $iOSSocketRequestExecutor, $processService, $socketProxyFactory) {
