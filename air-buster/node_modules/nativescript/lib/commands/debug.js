...
class DebugPlatformCommand {
    constructor(debugService, platform, $devicesService, $platformService, $projectData, $options, $platformsData, $logger, $errors, $debugDataService, $debugLiveSyncService, $config, $prompter, $liveSyncCommandHelper) {
        ...
        this.$debugLiveSyncService = $debugLiveSyncService;
        this.$config = $config;
    ...
    execute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.$options.start) {
                return this.$debugLiveSyncService.printDebugInformation(yield this.debugService.debug(debugData, debugOptions));
            }
            this.$config.debugLivesync = true;
            const selectedDeviceForDebug = yield this.getDeviceForDebug();
            yield this.$liveSyncCommandHelper.executeLiveSyncOperation([selectedDeviceForDebug], this.$debugLiveSyncService, this.platform);
        });
    }
    getDeviceForDebug() {
        return __awaiter(this, void 0, void 0, function* () {
...
class DebugIOSCommand {
    constructor($errors, $devicePlatformsConstants, $platformService, $options, $injector, $projectData, $platformsData, $iOSDebugService, $iosDeviceOperations) {
        this.$errors = $errors;
    ...
    get debugPlatformCommand() {
        return this.$injector.resolve(DebugPlatformCommand, { debugService: this.$iOSDebugService, platform: this.platform });
    }
    execute(args) {
    ...
    canExecute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield this.debugPlatformCommand.canExecute(args)) && (yield this.$platformService.validateOptions(this.$options.provision, this.$projectData, this.$platformsData.availablePlatforms.iOS));
        });
    }
}
__decorate([
...
class DebugAndroidCommand {
    constructor($errors, $devicePlatformsConstants, $platformService, $options, $injector, $projectData, $platformsData, $androidDebugService) {
        this.$errors = $errors;
        this.$devicePlatformsConstants = $devicePlatformsConstants;
        this.$platformService = $platformService;
        this.$options = $options;
    ...
    get debugPlatformCommand() {
        return this.$injector.resolve(DebugPlatformCommand, { debugService: this.$androidDebugService, platform: this.platform });
    }
    execute(args) {
        return this.debugPlatformCommand.execute(args);
    }
    canExecute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.debugPlatformCommand.canExecute(args)) && (yield this.$platformService.validateOptions(this.$options.provision, this.$projectData, this.$platformsData.availablePlatforms.Android));
        });
    }
}
__decorate([
