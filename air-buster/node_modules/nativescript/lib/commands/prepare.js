...
class PrepareCommand {
    ...
    execute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.$platformService.preparePlatform(args[0], appFilesUpdaterOptions, this.$options.platformTemplate, this.$projectData, this.$options);
        });
    }
    canExecute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const platform = args[0];
            const result = (yield this.$platformCommandParameter.validate(platform)) && (yield this.$platformService.validateOptions(this.$options.provision, this.$projectData, platform));
            if (result) {
