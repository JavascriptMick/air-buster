...
class RunCommandBase {
    constructor($platformService, $liveSyncService, $projectData, $options, $devicePlatformsConstants, $errors, $devicesService, $platformsData, $hostInfo, $liveSyncCommandHelper) {
    ...
    executeCore(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.$liveSyncCommandHelper.executeLiveSyncOperation(devices, this.$liveSyncService, this.platform);
        });
    }
}
...
class RunIosCommand {
    ...
    canExecute(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.runCommand.canExecute(args)) && (yield this.$platformService.validateOptions(this.$options.provision, this.$projectData, this.$platformsData.availablePlatforms.iOS));
        });
    }
}
__decorate([
